...
export const availableCountries = [
  {
    ...
    miniIcon: "/icons/countries/australia.svg",
    startPrice: 70,
    isPopular: false,
  },
  {
    ...
    miniIcon: "/icons/countries/austria.svg",
    startPrice: 70,
    isPopular: false,
  },
  {
    ...
    miniIcon: "/icons/countries/albania.svg",
    startPrice: 70,
    isPopular: false,
  },
  {
    ...
    miniIcon: "/icons/countries/algeria.svg",
    startPrice: 70,
    isPopular: false,
  },
  {
    ...
    miniIcon: "/icons/countries/argentina.svg",
    startPrice: 70,
    isPopular: false,
  },
  {
    ...
    miniIcon: "/icons/countries/armenia.svg",
    startPrice: 70,
    isPopular: false,
  },
  {
    ...
    miniIcon: "/icons/countries/bahamas.svg",
    startPrice: 70,
    isPopular: false,
  },
  {
    ...
    miniIcon: "/icons/countries/bangladesh.svg",
    startPrice: 70,
    isPopular: false,
  },
  {
    ...
    miniIcon: "/icons/countries/barbados.svg",
    startPrice: 70,
    isPopular: false,
  },
  {
    ...
    miniIcon: "/icons/countries/bahrain.svg",
    startPrice: 70,
    isPopular: false,
  },
  {
    ...
    miniIcon: "/icons/countries/belarus.svg",
    startPrice: 70,
    isPopular: false,
  },
  {
...
const CountriesModal = () => {
    ...
    const filteredCountries = React.useMemo(() => {
        ...
        return availableCountries.filter((country) => country.name.toLowerCase().indexOf(search.toLowerCase()) > -1,);
    }, [search]);
    ...
    return (<Modal
        className="space-y-5 min-h-75 w-full    max-[1024px]:h-dvh
    ...
    max-[1024px]:p-5"
        ...
        header={<Input
            ...
            options={availableCountries.map((country) => ({
                ...
                icon: country.miniIcon ? <img className="rounded-full object-cover w-5 h-5" src={country.miniIcon}/> : undefined,
            }))}
            color="primary"
            round="xl"
            autoFocus
        ...
        />}
    >
        {!!filteredPopularCountries.length && !search && (<div>
            <h2 className="font-semibold text-xl">Популярные страны</h2>

            <div className="grid md:grid-cols-2 gap-3">
                {filteredPopularCountries.map((country) => (<CountryCard
        ...
        <div>
            ...
            {filteredCountries.length ? (<div className="grid md:grid-cols-2 gap-3">
                {filteredCountries.map((country) => (<CountryCard
                    onClick={() => setModal(false)}
                    key={country.id}
                    id={country.id}
                    name={country.name}
                    ...
                    startPrice={country.startPrice}
                />))}
            </div>) : (<p className="text-gray-500 mt-3">
