...
const Button = ({
  ...
  const baseClasses =
    "cursor-pointer px-4 py-2 rounded-full disabled:opacity-70 disabled:cursor-not-allowed disabled:bg-neutral-300 disabled:text-neutral-500 transition-colors duration-200";
  const hoverClasses =
