...
import CompanyCarousel from "../components/shared/CompanyCarousel.tsx";

export default function MainPage() {
    const {setModal} = useTariffStore();
    const [reviews] = React.useState<Review[]>(mockReviews.slice(0, 4));
    return (
        <div>
            ...
            <div
                className="bg-white -mt-80 max-[950px]:-mt-60 px-5 max-[762px]:-mt-10 pt-10 relative rounded-t-[50px] space-y-15">
