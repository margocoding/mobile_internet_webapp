            ...
            <div className="min-h-screen flex flex-col max-md:px-4">
                        ...
                        <Card className="space-y-6 h-fit">
                            ...
                            <div className="space-y-4 lg:grid lg:grid-cols-2 gap-3">
                                <Card
                                    ...
                                    className={`w-full cursor-pointer h-full ${selectedPayment === "international"
                                            ? "border-[#F5A623]"
                                            : "border-[#E8E8E8]"
                                ...
                                <Card
                                    ...
                                    className={`w-full cursor-pointer h-full ${selectedPayment === "russian"
                                            ? "border-[#F5A623]"
                                            : "border-[#E8E8E8]"
                                        } border-2 p-4 text-left transition-all`}
                                >
                ...
                <Popup opened={openedPopup} setOpened={setOpenedPopup}>
                    ...
                    <div className="flex flex-col items-center text-center">
                        <img
                            src={orderType === 'renew' ? "/icons/esim.svg" : "/icons/order/success_order.svg"}
                            alt="success"
                        ...
                        {orderType === 'renew' ? <>
                            ...
                            <>
                                ...
                                {/* EMAIL */}
                                <div
                                    className=" mt-5 w-full rounded-2xl border border-[#DCE7FF] bg-[#F7FAFF] px-4 py-3 flex items-center gap-3 ">
                                    <img src="/icons/mail.svg" alt="mail" className="w-5 h-5" />{" "}
                                    <p className="font-medium break-all">{email}</p>{" "}
                                </div>
                                {/* INFO */}
                                <div
                                    className=" mt-4 w-full rounded-2xl border border-[#F5A623] bg-[#FFF9F1] px-4 py-3 flex items-start gap-3 text-left ">
